...
namespace BackendComputer.Controllers
{
    ...
    public class ApiStocksController : ControllerBase
    {
        ...
        public ApiStocksController(ComputerdbContext context)
        {
            _context = context;
        }
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Stock>> PostStock([FromForm] Stock data)
        {
            _context.Stock.Add(data);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetStock", new { msg = "OK" }, data);
        }
